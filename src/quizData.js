// quizData.js - Quiz enrichi : 7-10 questions par grain (QCM + Exercices pratiques)
    ...
    h5pQuestions: [
      {
        ...
        explanation: "Une ligne (tuple) représente un enregistrement concret. Ex : une ligne dans ETUDIANT = un étudiant précis."
      },
      {
        id: 2, type: 'qcm',
        ...
        explanation: "VARCHAR est utilisé pour les chaînes de caractères de longueur variable, idéal pour les noms."
      },
      {
        id: 3, type: 'qcm',
    ...
    h5pQuestions: [
      {
        ...
        explanation: "Une clé primaire doit être UNIQUE et NOT NULL — ses deux contraintes fondamentales."
      },
      {
        id: 2, type: 'qcm',
  ...
  4: {
    h5pQuestions: [
      ...
      },
      {
        ...
        explanation: "AS permet de renommer une colonne ou expression. Les calculs sont possibles directement dans SELECT."
      },
      {
        id: 6, type: 'qcm',
        ...
        explanation: "AS e crée un alias 'e' pour la table ETUDIANT. On utilise ensuite e.nom."
      },
      {
        id: 7, type: 'exercice',
        ...
        explanation: "SQL exécute : FROM → WHERE → SELECT → ORDER BY. L'ordre d'écriture est différent de l'ordre d'exécution."
      }
    ]
  },

  // ══════════════════════════════════════════════════════════
  // GRAIN 5 : Filtres WHERE et ORDER BY
  // ══════════════════════════════════════════════════════════
  5: {
    h5pQuestions: [
      {
        ...
        explanation: "WHERE est la clause de filtrage des lignes. HAVING est réservé aux groupes après GROUP BY."
      },
      {
        id: 2, type: 'qcm',
      ...
      },
      {
        ...
        explanation: "LIKE '%@gmail.com' utilise % comme joker. L'underscore _ remplace un seul caractère."
      },
      {
        id: 4, type: 'qcm',
      ...
      },
      {
        ...
        explanation: "BETWEEN 100 AND 500 est équivalent à prix >= 100 AND prix <= 500. ORDER BY vient après WHERE."
      },
      {
        id: 6, type: 'qcm',
        ...
        explanation: "NULL ne peut pas être comparé avec = en SQL. On utilise IS NULL ou IS NOT NULL."
      },
      {
        id: 7, type: 'exercice',
        ...
        explanation: "IN est plus lisible que plusieurs OR. Les deux sont équivalents mais IN est préféré."
      },
      {
        id: 8, type: 'qcm',
        ...
        explanation: "LIMIT n restreint le nombre de lignes retournées. Très utile pour la pagination."
      }
    ]
  },
    ...
    h5pQuestions: [
      {
        ...
        explanation: "INNER JOIN = intersection. LEFT JOIN = tout de gauche + correspondances de droite (NULL si absent)."
      },
      {
        id: 2, type: 'qcm',
      ...
      },
      {
        ...
        explanation: "CROSS JOIN génère n×m lignes. Rarement utile intentionnellement."
      },
      {
        id: 7, type: 'exercice',
  ...
  7: {
    h5pQuestions: [
      ...
      },
      {
        ...
        explanation: "MAX() retourne la valeur maximale. MIN() retourne le minimum. Les deux ignorent les NULL."
      }
    ]
  },
  ...
  9: {
    h5pQuestions: [
      ...
      },
      {
        ...
        explanation: "Sans transaction, les opérations partielles créent des incohérences. C'est pourquoi les transactions existent."
      },
      {
        id: 4, type: 'qcm',
      ...
      },
      {
        ...
        explanation: "ROLLBACK annule TOUTES les modifications depuis le BEGIN, pas seulement la dernière."
      },
      {
        id: 6, type: 'qcm',
        ...
        explanation: "ACID : Atomicité (tout ou rien), Cohérence, Isolation (entre transactions), Durabilité (persistance après COMMIT)."
      },
      {
        id: 7, type: 'exercice',
